...
public class FormulaOneKlasemenApp {
    ...
    public static void innerMenu1() {
        System.out.println("======================================");
        System.out.println("List Sirkuit Match");
        System.out.println("======================================");
        System.out.println("1. Bahrain");
        System.out.println("2. Saudi Arabia");
        System.out.println("3. Australia");
        System.out.println("4. Emilia Romagna");
        System.out.println("5. Miami");
        System.out.println("6. Spain");
        System.out.println("7. Monaco");
        System.out.println("8. Azerbaijan");
        System.out.println("9. Canada");
        System.out.println("10. Great Britain");
        System.out.println("11. Austria");
        System.out.println("12. France");
        System.out.println("13. Hungary");
        System.out.println("14. Belgium");
        System.out.println("15. Netherlands");
        System.out.println("16. Italy");
        System.out.println("17. Singapore");
        System.out.println("18. Japan");
        System.out.println("19. United States");
        System.out.println("20. Mexico");
        System.out.println("21. Brazil");
        System.out.println("22. Abu Dhabi");
    }
    ...
    static void gpEmiliaRomagna(SingleLinkedList klasemen, MatchRestult hasilRace) {
    ...
    static void gpPortugal(SingleLinkedList klasemen, MatchRestult hasilRace) {
    ...
    static void gpSpanyol(SingleLinkedList klasemen, MatchRestult hasilRace) {
    ...
    static void gpMonako(SingleLinkedList klasemen, MatchRestult hasilRace) {
    ...
    static void gpAzerbaijan(SingleLinkedList klasemen, MatchRestult hasilRace) {
    ...
    static void gpPerancis(SingleLinkedList klasemen, MatchRestult hasilRace) {
    ...
    static void gpAustria(SingleLinkedList klasemen, MatchRestult hasilRace) {
    ...
    static void gbAbuDhabi(DLL klasemen, Race hasilRace) {
